                    ...
                    <div v-if="profile">
                      ...
                      <div>
                        <v-tooltip top>
                          ...
                          <span
                            >Deleting this user will permanently remove them and
                            all their data. This action cannot be undone.</span
                          >
                        </v-tooltip>
                      </div>
                    </div>
...
<script lang="ts">
import { ConfirmDialog, useDialogStore } from '@mergin/lib'
