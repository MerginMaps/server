...
export { default as FileBrowserView } from './FileBrowserView.vue'
export { default as FileDetailView } from './FileDetailView.vue'
export { default as FileVersionDetailView } from './FileVersionDetailView.vue'
export { default as ProjectsListViewTemplate } from './ProjectsListViewTemplate.vue'
